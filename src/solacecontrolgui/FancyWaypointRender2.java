 ...
 */
public class FancyWaypointRender2 implements WaypointRenderer<MyWaypoint>
{
...
//    private final Font font = new Font("Lucida Sans", Font.BOLD, 10);
     ...
     */
    public FancyWaypointRender2()
    {
        URL resource = getClass().getResource("waypoint_white2.png");
